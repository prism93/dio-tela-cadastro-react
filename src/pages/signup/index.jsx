  ...
  return (
    <>
      ...
      <Container>
        <Column>
          <Title>
            A plataforma para<br/>você aprender com<br/>experts, dominar as<br/>principais<br/>
            tecnologias e<br/>entrar mais rápido<br/>nas empresas mais<br/>sdesejadas.
          </Title>
        </Column>
        <Column>
          <Wrapper>
            ...
            <Row>
             ...
             <TextBtn> <a href="/login">Fazer login.</a></TextBtn>
            </Row>
          </Wrapper>
        </Column>
      </Container>
